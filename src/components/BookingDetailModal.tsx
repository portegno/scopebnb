...
/**
 * Booking detail sheet, shared by the user dashboard and the admin orders view.
 * `extraRows` injects extra <Row> entries (e.g. admin-only contact details);
 * `footer` renders below the list (e.g. the admin status control).
 */
      ...
      >
        ...
        <div className="p-6">
          <div className="flex items-start justify-between gap-3">
            <h2 className="text-xl font-semibold tracking-tight">{b.targetName ?? "Target"}</h2>
